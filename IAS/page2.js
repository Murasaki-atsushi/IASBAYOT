...
const profilePic = localStorage.getItem('profilePic') || 'C:\\Users\\andre\\Music\\IAS\\defaultpfp.jpg'; // Default if not found
...
if (profilePic) {
    ...
    profilePicElement.src = 'C:\\Users\\andre\\Music\\IAS\\defaultpfp.jpg'; // Set to default if no profile picture
}
